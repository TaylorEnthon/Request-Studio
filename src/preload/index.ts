...
contextBridge.exposeInMainWorld('requestStudio', {
  ...
  environments: { list: (workspaceId: string) => invoke('environments:list', { workspaceId }), create: (input: unknown) => invoke('environments:create', input), rename: (input: unknown) => invoke('environments:rename', input), delete: (input: unknown) => invoke('environments:delete', input) },
